...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') Images @endslot
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="img-thumbnail rounded me-2" alt="200x200" width="200" src="{{URL::asset('assets/images/small/img-3.jpg')}}" data-holder-rendered="true">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="rounded-circle avatar-xl" alt="200x200" src="{{URL::asset('assets/images/users/user-4.jpg')}}" data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
                </div>
