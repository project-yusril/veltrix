            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <h5 class="font-size-18 mb-4"><i class="ti-agenda text-primary me-2"></i> General Questions
                            </h5>
                        ...
                        <div class="col-lg-5 offset-lg-1">
                            <h5 class="font-size-18 mb-4"><i class="ti-bookmark-alt text-primary me-2"></i> Pricing & Plans</h5>
