                        ...
                        <div class="card-body">
                            <div class="">
                                <div class="d-flex justify-content-end">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle text-muted fs-5" type="button"
                            ...
                            <div class="mt-n4 position-relative">
                                <div class="text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-4">
                                            <a href="" class="btn btn-primary waves-effect waves-light btn-sm">Send
                                                Message</a>
                                            <a href=""
                                                class="btn btn-primary waves-effect waves-light btn-sm">Email</a>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 pt-1">
                                ...
                                <li class="py-1"><i
                                        class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Quisque rutrum
                                    aenean imperdiet</li>
                                <li class="py-1"><i
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Gender</span><span>Male</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">DOB</span><span>01/02/2000</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Age</span><span>22</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span class="text-muted">Hire
                                        Date</span><span>22/08/2022</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Department</span><span>Graphic Design</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Location</span><span>Jannieborouth</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Position</span><span>UX Designer</span></li>
                                <li class="d-flex justify-content-between p-2 font-size-15"><span
                                        class="text-muted">Supervisor</span><span>Meson Jansen</span></li>
                            </ul>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="text-muted">Proin maximus nibh at lorem bibendum
                                                            venenatis. Cras gravida felis et erat consectetur, ac venenatis
                                                            quam pulvinar.
                                                            Cras neque neque, vehicula vel lacus quis, eleifend iaculis mi.
                                                            Curabitur in mi eget ex fringilla ultricies sit amet quis arcu.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-nowrap table-centered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="fw-medium text-reset">Ecommerce Product
                                                        Detail</a>
                                                </td>
                                                ...
                                                <td style="width: 160px;"><span
                                                        class="badge bg-primary-subtle text-primary font-size-12">Active</span>
                                                </td>
                                    ...
                                    <table class="table table-nowrap table-centered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td style="width: 160px;"><span
                                                        class="badge bg-secondary-subtle text-secondary font-size-12">Waiting</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>04 June, 2021</td>
                                                <td><span
                                                        class="badge bg-primary-subtle text-primary font-size-12">Approved</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="fw-medium text-reset">Contacts Profile
                                                        Page</a>
                                                </td>
                                                <td>
                                                    <p class="ml-4 text-muted mb-0">
                                    ...
                                    <table class="table table-nowrap table-centered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="fw-medium text-reset">Authentication
                                                        Pages</a>
                                                </td>
                                                    ...
                                                    <div class="simplebar-content" style="padding: 0px 16px;">
                                                        <div class="d-flex align-items-start border-bottom pb-4">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="text-muted">Maecenas non vestibulum ante, nec
                                                                    efficitur orci. Duis eu ornare mi, quis bibendum quam.
                                                                    Etiam imperdiet aliquam purus sit amet rhoncus.
                                                                    Vestibulum pretium consectetur leo, in mattis ipsum
                                                                    sollicitudin eget. Pellentesque vel mi tortor.
                                                                    Nullam vitae maximus dui dolor sit amet, consectetur
                                                                    adipiscing elit.</p>
                                                                ...
                                                                <div class="d-flex align-items-start mt-4">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h5 class="font-size-15 mb-1">Shanon Marvin <small
                                                                                class="text-muted float-end">1 hr
                                                                                ago</small></h5>
                                                                        <p class="text-muted">It will be as simple as in
                                                                            fact, it will be Occidental. To it will seem
                                                                            like simplified .</p>
                                                        ...
                                                        <div class="d-flex align-items-start border-bottom py-4">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="text-muted">Cras ac condimentum velit. Quisque
                                                                    vitae elit auctor quam egestas congue. Duis eget lorem
                                                                    fringilla, ultrices justo consequat, gravida lorem.
                                                                    Maecenas orci enim, sodales id condimentum et, nisl arcu
                                                                    aliquam velit,
                                                                    sit amet vehicula turpis metus cursus dolor cursus eget
                                                                    dui.</p>
                                                        ...
                                                        <div class="d-flex align-items-start border-bottom py-4">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img class="rounded-circle avatar-sm"
                                                                    src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}"
                                                                    alt="avatar-7 images">
                                                            </div>
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="text-muted">Aliquam sit amet eros eleifend,
                                                                    ...
                                                                    In ac consectetur augue. Nullam pulvinar risus non augue
                                                                    tincidunt blandit.</p>
                                    ...
                                    <form action="#">
                                        <div class="px-2 py-1 bg-light">
                                            ...
                                            <div class="btn-group" role="group">
                                                <button type="button"
                                                    class="btn btn-sm btn-link text-reset text-decoration-none"><i
                            ...
                            <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="font-size-15 text-truncate"><a href="#"
                                                    class="text-reset">Richard Johnson</a></h5>
                                ...
                                <div class="blog-post mt-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="font-size-15 text-truncate"><a href="#"
                                                    class="text-reset">Michael Smith</a></h5>
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                    class="text-reset">Daniel Canales</a></h5>
                                        </td>
                                        <td>
                                            <div>
                                                <a href="javascript: void(0);"
                                                    class="badge bg-primary-subtle text-primary text-primary font-size-13">Frontend</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                    class="text-reset">Jennifer Walker</a></h5>
                                        </td>
                                        <td>
                                            <div>
                                                <a href="javascript: void(0);"
                                                    class="badge bg-primary-subtle text-primary text-primary font-size-13">UI
                                                    / UX</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                    class="text-reset">Carl Mackay</a></h5>
                                        </td>
                                        <td>
                                            <div>
                                                <a href="javascript: void(0);"
                                                    class="badge bg-primary-subtle text-primary text-primary font-size-13">Backend</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                    class="text-reset">Janice Cole</a></h5>
                                        </td>
                                        <td>
                                            <div>
                                                <a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                    class="text-reset">Tony Brafford</a></h5>
                                        </td>
                                        <td>
                                            <div>
                                                <a href="javascript: void(0);"
