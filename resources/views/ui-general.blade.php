...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') General @endslot
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items">
                        ...
                        <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                            Popover on bottom
                        </button>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="font-size-16">Default Example</h5>
                        ...
                        <div class="col-lg-6">
                            <h5 class="font-size-16">Disabled and active states</h5>
